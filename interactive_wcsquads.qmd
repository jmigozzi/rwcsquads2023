---
title: "Geography of the 2023 rugby world cup"
subtitle: "Where are rugby players coming from?"
...
These interactive maps display the place of birth of players participating in the 2023 Rugby World Cup.

The data was sourced from Wikipedia and is therefore sometimes incomplete.
...
The table displays only players for which the place of birth was mentioned on wikipedia.
...
When available, the place of birth was extracted from [Wikipedia](https://en.wikipedia.org/wiki/2023_Rugby_World_Cup_squads), then geocoded with OpenStreetMap. 591 players have been geocoded for a total of 675 players. Data is incomplete for a few countries, especially for Chili and Portugal: sometimes there is no wikipedia page for the player, or the place of birth is not mentioned.
